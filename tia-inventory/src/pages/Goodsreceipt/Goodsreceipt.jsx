...
export default function GoodsReceipt() {
  ...
  const handleStatusFilterChange    = (value) => { setStatusFilter(value);    setStatusAnchor(null);    };
  const handleConditionFilterChange = (value) => { setConditionFilter(value); setConditionAnchor(null); };
    ...
    <Box sx={{ background: "#f8f9fb", minHeight: "100vh" }}>
      <Box sx={{ p: "28px 32px", boxSizing: "border-box" }}>
        ...
        <Box sx={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", flexWrap:"wrap", gap:2, mb:3 }}>
          <Box>
            <Typography sx={{ margin: 0, fontSize: 20, fontWeight: 700, color: "#111827" }}>
              Goods Receipt (GRN)
            </Typography>
        ...
        <Box sx={{ display: "flex", gap: "12px", alignItems: "center", mb: "20px", flexWrap: "wrap" }}>
          <Box
            sx={{
              ...
              px: 1.5, py: 0.75, bgcolor: "#fff", width: 260,
            }}
          >
          ...
          >
            {["All Conditions", "Good", "Short Delivery", "Damaged"].map((opt) => (
              <MenuItem key={opt} onClick={() => handleConditionFilterChange(opt)} sx={{ fontSize: 13, color: "#374151", py: 0.75 }}>
                {opt}
              </MenuItem>
            ))}
          </Menu>
          ...
          <Menu
            ...
            PaperProps={{ sx: { boxShadow: "0 4px 12px rgba(0,0,0,0.1)", borderRadius: "8px", mt: 0.5, minWidth: 150 } }}
          >
            {["All Statuses", "Completed", "Discrepancy", "Pending"].map((opt) => (
              <MenuItem key={opt} onClick={() => handleStatusFilterChange(opt)} sx={{ fontSize: 13, color: "#374151", py: 0.75 }}>
                {opt}
              </MenuItem>
            ))}
          </Menu>
                    ...
                    >
                      ...
                      <TableCell>
                        <Chip
                          ...
                          sx={{
                            ...
                            border: "1px solid #ede9fe", borderRadius: "6px",
                      ...
                      <TableCell>
                        <Chip
                          ...
                          size="small"
                          sx={{ height: 22, fontSize: 11, fontWeight: 600, bgcolor: ss.bg, color: ss.color }}
                        />
                      </TableCell>
                      <TableCell align="center">
                        <IconButton
                          ...
                          sx={{
                            color: "#9ca3af", p: 0.5, borderRadius: "6px",
          ...
          <>
            ...
            <Box
              sx={{
                ...
                borderBottom: "1px solid #f3f4f6", bgcolor: "#fff",
              }}
            >
            ...
            <DialogContent sx={{ px: "24px", py: "8px", bgcolor: "#fff" }}>
              ...
              {[
                ...
                { label: "Condition",   value: viewReceipt.condition, valueColor: getConditionStyle(viewReceipt.condition).color },
              ].map((row) => (
                <ViewRow key={row.label} label={row.label} value={row.value} valueColor={row.valueColor} />
              ))}
            ...
            <Box sx={{ px: "24px", py: "14px", display: "flex", justifyContent: "flex-end", bgcolor: "#fff" }}>
              <Button
                ...
                sx={{
                  ...
                  bgcolor: "#fff", "&:hover": { bgcolor: "#f9fafb" }, "&:focus": { outline: "none" },
                }}
              >
                Close
              </Button>
