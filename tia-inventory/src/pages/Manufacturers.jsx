            ...
            <>
              ...
              <Box sx={{ 
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  <Typography sx={{ fontSize: '0.8rem', color: '#64748b' }}>
                    {page * rowsPerPage + 1}-{Math.min((page + 1) * rowsPerPage, manufacturers.length)} of {manufacturers.length}
                  </Typography>
                  <Box sx={{ display: 'flex', gap: 0.5 }}>
                    ...
                    <IconButton
                      ...
                      disabled={page >= Math.ceil(manufacturers.length / rowsPerPage) - 1}
                      sx={{
                        color: page >= Math.ceil(manufacturers.length / rowsPerPage) - 1 ? '#cbd5e1' : '#2563eb',
                        p: 0.5,
                        '&:hover': {
                          backgroundColor: page >= Math.ceil(manufacturers.length / rowsPerPage) - 1 ? 'transparent' : '#eff6ff',
                        },
                      }}
                    >
