...
import {
  ...
  People, Business, Category, Description,
  LocalShipping, Factory, ExpandMore, Settings,
  Group,
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ display:"flex", alignItems:"center", justifyContent:"space-between", mb:0.4 }}>
        <Typography sx={{ fontSize:10, fontWeight:700, color:C.textSecondary, letterSpacing:0.7, textTransform:"uppercase" }}>
          {label}
        </Typography>
        {Icon && <Icon sx={{ fontSize:15, color }} />}
      </Box>
      <Typography sx={{ fontSize:24, fontWeight:800, color:C.textPrimary, lineHeight:1.15 }}>
        {value}
      </Typography>
      {sub && (
        <Typography sx={{ fontSize:11, fontWeight:600, color:C.textSecondary, mt:0.2 }}>
          {sub}
        </Typography>
      )}
    </Box>
    ...
    <Box sx={{
      ...
      <Box sx={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between" }}>
        <Box>
          ...
          <Typography sx={{ fontSize:10, color:C.textSecondary, fontWeight:600, letterSpacing:0.5, textTransform:"uppercase", mt:0.1 }}>
            {loc.type}
          </Typography>
        </Box>
        <Chip label={loc.id} size="small" sx={{
      ...
      <Box sx={{ display:"flex", gap:1, mt:0.5 }}>
        <Button size="small" variant="outlined"
          ...
          sx={{
            ...
            "&:hover":{ borderColor:"#9CA3AF", bgcolor:"#F9FAFB" }, px:1.2, height:26,
          }}>
      ...
      <Box sx={{ flex:1, minWidth:0 }}>
        ...
        <Box sx={{ display:"flex", alignItems:"center", gap:0.8, mt:0.2 }}>
          <Chip label={user.role} size="small" sx={{
            bgcolor:user.roleBg, color:user.roleColor,
