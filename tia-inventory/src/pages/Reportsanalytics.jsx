  ...
  return (
    ...
    >
      ...
      >
        <Box>
          <Typography
            sx={{ fontWeight: 700, fontSize: 13, color: C.textPrimary }}
          >
            {title}
          </Typography>
          {subtitle && (
            <Typography sx={{ fontSize: 11, color: C.textSecondary, mt: 0.2 }}>
              {subtitle}
            </Typography>
          )}
        </Box>
...
function CustomTooltip({ active, payload, label, prefix = "$", suffix = "" }) {
  ...
  return (
    ...
    >
      <Typography
        sx={{ fontSize: 11, fontWeight: 700, color: C.textSecondary, mb: 0.3 }}
      >
        {label}
      </Typography>
      <Typography sx={{ fontSize: 13, fontWeight: 800, color: C.textPrimary }}>
        {prefix}
        {typeof payload[0].value === "number" && prefix === "$"
      ...
      <Box sx={{ p: "24px 28px" }}>
        ...
        <Box sx={{ display: "flex", gap: 2, mb: 2, minWidth: 0 }}>
          ...
          <Box sx={{ flex: "0 0 58%", minWidth: 0 }}>
            <SectionCard
              title="Monthly Spend Trend ($K)"
              subtitle="Sep 2025 – Mar 2026"
            >
        ...
        <Box sx={{ display: "flex", gap: 2, mb: 2, minWidth: 0 }}>
          ...
          <Box sx={{ flex: "0 0 58%", minWidth: 0 }}>
            <SectionCard
              title="Issue Volume by Department"
              subtitle="Total stock issues per department"
            >
              <Box sx={{ width: "100%", height: 200 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                  ...
                  >
                    ...
                    />
                    <RTooltip
                      content={<CustomTooltip prefix="" suffix=" issues" />}
                    />
          ...
          <Box sx={{ flex: "1 1 0", minWidth: 0 }}>
            <SectionCard
              ...
              subtitle="Purchase order distribution"
            >
              <Box
                sx={{
                  display: "flex",
