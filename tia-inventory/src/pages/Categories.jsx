...
const initialCategories = [
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        code: "PH-AN",
        icon: "🖼️",
        description: "Pain relief including opioids & NSAIDs",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "PH-IV",
        icon: "🖊️",
        description: "Intravenous fluids and infusions",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "PH-EM",
        icon: "🚨",
        description: "Critical care and crash cart medications",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "PH-AE",
        icon: "🤩",
        description: "Local and general anaesthetic agents",
        items: 1,
        status: "Active",
      },
      {
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        code: "SS-CD",
        icon: "🪡",
        description: "Drainage and catheter sets",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "SS-NS",
        icon: "💉",
        description: "Injection and infusion needles",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "SS-SI",
        icon: "🔧",
        description: "Operating room instruments",
        items: 2,
        status: "Active",
      },
    ],
    ...
    subcategories: [
      {
        ...
        code: "PP-GL",
        icon: "🧤",
        description: "Sterile and exam gloves",
        items: 3,
        status: "Active",
      },
      {
        ...
        code: "PP-MR",
        icon: "😷",
        description: "Surgical and N95 masks",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "PP-GC",
        icon: "🥼",
        description: "Sterile surgical gowns",
        items: 1,
        status: "Active",
      },
      {
        ...
        code: "PP-EF",
        icon: "🥽",
        description: "Goggles, shields and visors",
        items: 2,
        status: "Active",
      },
    ],
    ...
    subcategories: [
      {
        ...
        code: "LS-CT",
        icon: "🔵",
        description: "Blood collection and specimen tubes",
        items: 2,
        status: "Active",
      },
      {
      ...
      },
      {
        ...
        code: "LS-CM",
        icon: "🦠",
        description: "Microbiology culture materials",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "LS-PT",
        icon: "💧",
        description: "Liquid handling consumables",
        items: 2,
        status: "Active",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        code: "ED-IP",
        icon: "⚙️",
        description: "IV and medication infusion pumps",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "ED-DD",
        icon: "🔨",
        description: "Imaging and diagnostic tools",
        items: 1,
        status: "Active",
      },
    ],
    ...
    subcategories: [
      {
        ...
        code: "WC-DR",
        icon: "🖊️",
        description: "Primary wound dressings",
        items: 2,
        status: "Active",
      },
      {
        ...
        code: "WC-BT",
        icon: "🎀",
        description: "Bandaging and adhesive tapes",
        items: 1,
        status: "Active",
      },
      {
        ...
        code: "WC-AS",
        icon: "🧴",
        description: "Wound cleaning solutions",
        items: 1,
        status: "Active",
      },
    ],
...
const StatusChip = ({ status }) => (
  <span
    style={{
      ...
      border: `1.5px solid ${status === "Active" ? "#bbf7d0" : "#e2e8f0"}`,
      whiteSpace: "nowrap",
      marginRight: "20px",
    }}
  >
...
function CategoryModal({
  ...
  const subtitle = isSub
    ? "Belongs under a parent category"
        ...
        >
              ...
              {[
                {
                  val: "category",
                  label: "Category",
                  sub: "Top-level grouping",
                  emoji: "🗂️",
                },
                {
                  val: "subcategory",
                  label: "Subcategory",
                  sub: "Belongs to a category",
                  emoji: "📁",
                },
              ].map((opt) => (
                <button
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setErrors((p) => ({ ...p, parent: null }));
                }}
                style={{
                  ...selectSt,
                  borderColor: errors.parent ? "#fca5a5" : "#e2e8f0",
                }}
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              style={{ ...inputSt, resize: "vertical", lineHeight: 1 }}
            />
          </div>
        </div>
...
const PencilIcon = ({ size = 12 }) => (
  <span style={{ fontSize: size + 2, color: "#d97706" }}>✏️</span>
);

const BanIcon = ({ size = 12 }) => (
  ...
  const handleSave = ({
    ...
    if (editItem) {
      if (editItem._isSub) {
        setCats((prev) =>
          prev.map((c) =>
            c.id !== editItem._catId
              ? c
              : {
                  ...c,
                  subcategories: c.subcategories.map((s) =>
                    s.id === editItem.id
                      ? { ...s, name, code, icon, description, status }
                      : s,
                  ),
                },
          ),
        ...
        setCats((prev) =>
          prev.map((c) =>
            c.id === editItem.id
              ? { ...c, name, code, icon, description, status }
              : c,
          ),
        );
      }
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button
            onClick={() =>
              setModal({ mode: "add-subcategory", prefillParent: "" })
            }
            style={{
              padding: "9px 16px",
              border: "1.5px solid #e2e8f0",
          ...
          <button
            onClick={() =>
              setModal({ mode: "add-category", prefillParent: "" })
            }
            style={{
              padding: "9px 18px",
              border: "none",
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div
                  style={{ fontWeight: 700, fontSize: 14.5, color: "#0f172a" }}
                >
                  {cat.name}
                </div>
                <div style={{ fontSize: 11.5, color: "#94a3b8", marginTop: 1 }}>
                  {cat.description} · {cat.items} items ·{" "}
              ...
              >
                <button
                  onClick={() =>
                    setModal({ mode: "add-subcategory", prefillParent: cat.id })
                  }
                  style={{
                    padding: "4px 10px",
                    border: "1.5px solid #e2e8f0",
                ...
                <IBtn
                  onClick={() => toggleStatus(cat.id, null)}
              ...
              <svg
                ...
                strokeLinejoin="round"
                style={{
                  transform: collapsed[cat.id] ? "rotate(-90deg)" : "rotate(0)",
              ...
              <div style={{ borderTop: "1px solid #f1f5f9" }}>
                ...
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns:
                      "minmax(150px,1fr) 90px minmax(150px,1.2fr) 55px 90px 68px",
                      ...
                      <IBtn
                        onClick={() =>
                          setModal({
                            ...
                            editItem: { ...sub, _isSub: true, _catId: cat.id },
                          })
                        }
                        title="Edit"
                        border="#fde68a"
