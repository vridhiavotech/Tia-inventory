...
const CATEGORY_ICONS = {
  ...
  "Wound Care": {
    icon: <HealingIcon sx={{ fontSize: 17 }} />,
    bg: "#fce7f3",
    color: "#db2777",
  },
  "Lab Supplies": {
...
const SUBCATEGORY_ICONS = {
  Antibiotics: {
    icon: <MedicationIcon sx={{ fontSize: 13 }} />,
    color: "#7c3aed",
  },
  "Emergency Drugs": {
  ...
  Gloves: {
    icon: <HealthAndSafetyIcon sx={{ fontSize: 13 }} />,
    color: "#16a34a",
  },
  "Masks & Respirators": {
    icon: <HealthAndSafetyIcon sx={{ fontSize: 13 }} />,
  ...
  "Collection Tubes": {
    icon: <VaccinesIcon sx={{ fontSize: 13 }} />,
    color: "#0284c7",
  },
  Monitoring: {
    icon: <MonitorHeartIcon sx={{ fontSize: 13 }} />,
    color: "#475569",
  },
};
...
function StatusChip({ label, color, icon }) {
  ...
  return (
    ...
    >
      {icon && (
        <Box sx={{ display: "flex", alignItems: "center", color: s.color }}>
          {icon}
        </Box>
      )}
      {label}
...
export default function InventoryItems() {
  ...
  const closeDeleteDialog = () => {
    if (!deleting) setDeleteDialog({ open: false, item: null });
  };
          ...
          <Select
            ...
            sx={{
              ...
              "& .MuiOutlinedInput-notchedOutline": {
                borderColor: "#e5e7eb", // default
                borderWidth: "1px",

              },

              "&:hover .MuiOutlinedInput-notchedOutline": {
                borderColor: "#015DFF", // 👈 blue on hover
                borderWidth: "1px",
              },
            ...
            <TableBody>
              {filtered.map((item, idx) => (
                ...
                >
                  ...
                  <TableCell>
                    ...
                    >
                      <Box
                        sx={{
                          color:
                            CATEGORY_ICONS[item.category]?.color || "#6b7280",
                          display: "flex",
                          flexShrink: 0,
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          color:
                            SUBCATEGORY_ICONS[item.subcategory]?.color ||
                            "#9ca3af",
                          display: "flex",
                          flexShrink: 0,
                        }}
                      >
                        {SUBCATEGORY_ICONS[item.subcategory]?.icon}
                      </Box>
                      <Typography sx={{ fontSize: 11, color: "#9ca3af" }}>
                        {item.subcategory}
                      </Typography>
                  ...
                  <TableCell>
                    <Typography sx={{ fontSize: 14, color: "#2E2E2E" }}>
                      {item.par}
                    </Typography>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Typography
                      sx={{
                        fontSize: 12,
                        fontWeight:
                          item.expired || item.expiringSoon ? 600 : 400,
                        color: item.expired
                          ? "#ef4444"
                          : item.expiringSoon
                            ? "#f59e0b"
                    ...
                    <Box sx={{ display: "flex", gap: "4px" }}>
                      <Tooltip title="Edit">
                        <IconButton
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/inventory/add?id=${item.id}&edit=true`,
                            )
                          }
                          sx={{
                            color: "#6b7280",
                      ...
                      <Tooltip title="Transfer">
                        <IconButton
                          size="small"
                          onClick={() =>
                            setTransferModal({ open: true, item: item.name })
                          }
                          sx={{
                            color: "#6b7280",
                            border: "1px solid #e5e7eb",
                      ...
                      <Tooltip title="Issue Stock">
                        <IconButton
                          size="small"
                          onClick={() =>
                            setIssueModal({ open: true, item: item.name })
                          }
                          sx={{
                            color: "#6b7280",
                            border: "1px solid #e5e7eb",
